...
public class HTMLCanvasElement extends Image implements IObserver {
	...
	private static int getContainerWidth() {
		return Document.getInstance().getWidth();
	}
	
	private static int getContainerHeight() {
		return Document.getInstance().getHeight();
	}
	...
	public HTMLCanvasElement() {
		...
		this(getContainerWidth(), getContainerHeight());		
	}
