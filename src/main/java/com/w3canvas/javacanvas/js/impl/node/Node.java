...
public class Node extends ProjectScriptableObject implements EventTarget, INodeUtils {
	...
	public Object jsGet_clientLeft() {
		return getStyleValue("clientLeft", 0);
	}
	
	public Object jsGet_clientTop() {
		return getStyleValue("clientTop", 0);
	}
	
	public Object jsGet_currentStyle() {
		return this;
	}
